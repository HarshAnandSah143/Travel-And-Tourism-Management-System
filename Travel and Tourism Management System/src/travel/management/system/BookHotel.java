		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String priceText = l5.getText(); // e.g., "Rs 24000"
                                String cleanPrice = priceText.replaceAll("[^0-9]", ""); // "24000"
                                int totalPrice = Integer.parseInt(cleanPrice);

                                String q1 = "insert into bookHotel values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', "+totalPrice+")";
